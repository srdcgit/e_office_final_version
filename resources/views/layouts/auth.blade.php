...
<body background="{{ $logo . 'parichay-bg.png' }}" style="background-size:cover">
    <!-- [ auth-signup ] start -->
    <div>
        <div class="bg-auth-side bg-primary"></div>
        <div class="auth-content">
            <div class="row align-items-center justify-content-center text-start">
                <div class="col-xl-6 text-center cust-margin" style="margin-top:0;width:400px">
                    <div class="mx-3" style="margin-top:25px">
                    ...
                    @yield('content')
                    <footer class="dash-footer" style="margin-bottom:0">
