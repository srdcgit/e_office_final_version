...
@section('file_content')
    ...
    <form action="{{ route('storefile.share') }}" method="post">
        <div class="row p-4">
            <div class="col-md-7">
                <div class="card p-3 mb-3">
                    ...
                    <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link text-dark" id="recent-tab" data-bs-toggle="tab"
                                data-bs-target="#recent-tab-pane" type="button" role="tab"
                                aria-controls="recent-tab-pane" aria-selected="false">Recent 10</button>
                        </li>
                        <li class="nav-item" role="presentation">
                    ...
                    <div class="row mb-1">
                        <div class="col-12">
                            <span class="form-text text-muted" style="font-style:italic"><b>Note :</b> Email/SMS will be
                                sent
