<div class="dropdown dash-h-item">
    ...
    <div class="dropdown-menu" x-placement="bottom-start">
        <a href="{{ route('section.edit', $section->id) }}" class=" dropdown-item">
            <i class="ti ti-edit action-btn"></i>{{ __('Edit') }}
        </a>
        {{--  <div class="dropdown-divider"></div>  --}}
        <a href="{{ route('section.index') }}" class="dropdown-item  text-danger" data-toggle="tooltip"
            data-original-title="{{ __('Delete') }}" onclick="delete_record('delete-form-{{ $section->id }}')"><i
