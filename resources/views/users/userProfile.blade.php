...
$profile = asset('assets/images/user/');
...
<div class="row">
    ...
    <div class="col-sm-12">
        <div class="row">
            ...
            <div class="col-xl-9">
                <div id="useradd-1" class="card bg-primary text-white" style="margin-top: 0.5%; background-color: white !important;">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="avatar me-3">
                                <img src="{{ !empty($userDetail->avatar) ? $profile . '/' . $userDetail->avatar : $profile . 'avatar.jpg'}}" ;
                                    alt="kal" class="img-user wid-80 rounded-circle" style="width: 100px;
                                    margin-top: 10px !important;">

                            </div>
                            <div class="d-block d-sm-flex align-items-center justify-content-between w-100">
                                <div class="mb-3 mb-sm-0">
                                    <h4 class="mb-1 text-black">{{ $userDetail->name }}</h4>
                                    <p class="mb-0 text-black text-sm">{{ $userDetail->type }}</p>
                                </div>
                ...
                <div id="useradd-2" class="card" style="margin-top: 1%;">
                ...
                <div id="useradd-3" class="card" style="margin-top: 1%;">
                    <div class="card-header">
