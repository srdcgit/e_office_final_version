                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="priority" id="priority" class="form-control">
                                ...
                                <option value="highi">Highi</option>
                        ...
                        <div class="form-group">
                            {{ Form::label('date', __('DueDate'), ['class' => 'form-label']) }}
                            {{ Form::date('duedate', null, ['class' => 'form-control',  'placeholder' => __('Enter Date')]) }}
                            @error('duedate')
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::text('comments', null, ['class' => 'form-control',  'placeholder' => __('Enter Comments')]) }}
                            @error('comments')
                            <span class="invalid-name" role="alert">
                                <strong class="text-danger">{{ $message }}</strong>
                            </span>
