                    ...
                    <div class="card-body">
                        ...
                        <div class="">
                            <div class=" row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        {{ Form::label('name', __('Facebook URL'), ['class' => 'form-label']) }}
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        {{ Form::label('name', __('LinkedIn URL'), ['class' => 'form-label']) }}
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        {{ Form::label('name', __('Twitter(X) URL'), ['class' => 'form-label']) }}
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        {{ Form::label('name', __('Organization Name'), ['class' => 'form-label']) }}
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        {{ Form::label('name', __('Authority'), ['class' => 'form-label']) }}
...
<script>
    ...
    $('body').on('click', '.send_mail', function() {
        ...
        $.get(action, function(response) {
            modal.find('.modal-title').html('{{ __('
                Test Mail ') }}');
