...
class CommunicationDataTable extends DataTable
{
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('action', function (Communication $communication) {
                return view('communication.action', compact('communication'));
            });
    }
    public function query(Communication $model)
    {
