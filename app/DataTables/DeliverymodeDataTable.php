...
class DeliverymodeDataTable extends DataTable
{
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('action', function (Deliverymode $deliverymode) {
                return view('deliverymode.action', compact('deliverymode'));
            });
    }
    public function query(Deliverymode $model)
    {
    ...
    {
        return $this->builder()
            ->setTableId('deliverymodes-table')
